...
public class RedshiftApplication {
    ...
    static final String dbURL = "jdbc:redshift://kdsa1uat-redshift-cluster.cxvowp49opna.cn-northwest-1.redshift.amazonaws.com.cn:8639/energy_test";
    static final String MasterUsername = "energy_user";
    static final String MasterUserPassword = "KZfpL0xtSfGfpKpK";
